...
- [x] Scraper unresolved 2,897 -> 2,106 (17.4% -> 12.6%); precision holds at 99.93% with 1,066 more edges checkable; TS subjects byte-identical
...
- [ ] `impact` zero-result honesty: state what was examined and how many references in this graph are unresolved, so an empty answer carries its own confidence — T7's true zero and T3's broken zero printed identically
...
- [ ] Full re-run of tasks.md for the record once todo42's typed-receiver work lands — T3/T4 already re-measured above
