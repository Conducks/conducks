...
- [x] 26 declarations on orchestrator still have no node at the author's line — down from 76, and the remainder is unexamined → examined via re-run 2026-08-06: the .mjs extensions fix landed and the residue is now 2 of 705 (99.1% text-match); sofie 1 of 854 (99.5%), scraper unchanged — the tail is the recorded file-header ambiguity class, not a missing parser
