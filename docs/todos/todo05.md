...
- [ ] MULTI-LANG — Go (go-llms, 469 files) still BROKEN: tree-sitter-go@0.25 returns NULL tree on tree-sitter@0.21.1 runtime (ABI mismatch), every .go file falls back to edge-less Gnosis extractor — needs pin to a 0.21-compatible tree-sitter-go release (or runtime bump) and native binding rebuild
