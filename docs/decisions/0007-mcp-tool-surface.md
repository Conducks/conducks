...
Status: Accepted
- Enforced by: tests/unit/domain/coverage/coverage-bind.test.ts (shared coverage-bind.ts module); symbol `conducks_docs`/`conducks_coverage` tool registrations (src/interfaces/tools/tools/synapse.ts:722,820)
- Date: 2026-07-18
