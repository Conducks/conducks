...
- Date: 2026-08-05
- Enforced by: tests/unit/domain/docs/visuals-lint.test.ts (every failure mode below is a case; the ambiguity refusal and the constant check are the two that carry the decision)
