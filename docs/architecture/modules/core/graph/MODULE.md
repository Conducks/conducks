...
persist, and does not decide what a finding *means* — [governance](../../domain/governance/MODULE.md)
owns judgement.
...
- **[algorithms/](algorithms/MODULE.md)** — Tarjan cycle detection, gravity ranking, traversal.
- **[linkers/](linkers/MODULE.md)** — binding bare names and specifiers to real nodes across files
  and repos.
