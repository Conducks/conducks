...
**Part of:** [core/graph](../MODULE.md). Three static classes: `CycleDetector`, `StructuralRanker`,
`GraphTraversal`.
...
SCCs; whether an SCC is an ARCH-3 violation is [governance](../../../domain/governance/MODULE.md)'s
