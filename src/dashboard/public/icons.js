/**
 * CONDUCKS Dashboard Icon System
 * Professional SVG icons to replace emoji usage
 */
...
const icons = {
    ...
    briefcase: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    circle: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="12" cy="12" r="10"></circle>
  </svg>`,

    // Loading spinner
    loader: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="spinner">
...
function createIcon(name, size = 20, className = '') {
    ...
    wrapper.innerHTML = getIcon(name, size, className);
    return wrapper;
}
